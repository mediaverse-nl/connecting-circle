...
@section('content')
    {{Form::model($job, ['route' => ['admin.jobs.update', $job->id], 'method' => 'PATCH', 'files' => true])}}
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    ...
                    <span class="float-right">
                        <div style="display: inline-block" class="px-2">
                            ...
                            {!! Form::checkbox('live', null, null, ['id="customSwitch1"', 'class' => 'custom-control-input '.(!$errors->has('plaats') ? '': ' is-invalid ')]) !!}
...
{{--                              <input name="live" type="checkbox" class="custom-control-input" id="customSwitch1">--}}
                        ...
                        <div style="display: inline-block">
                            @component('admin.components.model', [
                               'id' => 'editPage',
                               'title' => 'Vacature wijzigen',
                               'actionRoute' => route('admin.jobs.update', $job->id),
