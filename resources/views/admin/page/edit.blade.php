...
{{--    {{Form::open(['route' => ['admin.page.store'], 'method' => 'POST', 'files' => true])}}--}}
    ...
    {{Form::model($page, ['route' => ['admin.page.update', $page->id], 'method' => 'PATCH', 'files' => true])}}
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                    <span class="h3 align-items-center">
                        ...
                        @component('admin.components.model', [
                               ...
                               'actionRoute' => route('admin.page.update', $page->id),
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::text('slug', url('/').$page->slug, ['disabled', 'class' => 'form-control'.(!$errors->has('slug') ? '': ' is-invalid ')]) !!}
                ...
                <div class="form-group" style="height: 100px">
                    <img src="/{{$twitterDefaultImage}}" class="img-fluid" style="height: 100%; object-fit: contain;" alt="">
                </div>
                <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <?php
                    $ogDefaultImage = isset($page->meta_image_open_graph)
                        ? $page->meta_image_open_graph
                        : '//placehold.it/150';
                ?>
                <div class="form-group" style="height: 100px">
                    <img src="/{{$ogDefaultImage}}" class="img-fluid" style="height: 100%; object-fit: contain;" alt="">
                </div>
                <div class="form-group">
